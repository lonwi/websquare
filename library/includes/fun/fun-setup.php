...
if (!function_exists('websquare_enqueue_scripts')) {
	...
	function websquare_enqueue_scripts()
	{
		...
		$css_version = $theme_version . '.' . filemtime(get_template_directory() . '/library/assets/css/theme.min.css');
		$js_version = $theme_version . '.' . filemtime(get_template_directory() . '/library/assets/js/theme.min.js');

		wp_enqueue_style('websquare-styles', get_template_directory_uri() . '/library/assets/css/theme.min.css', array(), $css_version);
